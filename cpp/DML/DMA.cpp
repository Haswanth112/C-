...
public:
    Student() : Person("", 0) {}
    Student(string name, int age, float grade) : Person(name, age), grade(grade) {}
    ...
    ~Student()
    {
        cout << "Distructor  called for student: " << Person::getName() << endl;
    }
};
...
public:
    ...
    ~Teacher()
    {
        cout << "Distructor called for Teacher: " << Person::getName() << endl;
    }
};
